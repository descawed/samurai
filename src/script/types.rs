...
static FUNCTION_OBFUSCATION_MAP: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
    hash_map! {
        // event callbacks
        "A00" => "TalkSelect",
        "A01" => "TalkStart",
...
static SIGNATURES: LazyLock<HashMap<&'static str, Signature>> = LazyLock::new(|| {
    hash_map! {
        ...
        "SetCharMotion" => Signature::args(vec![EnumType::Character, EnumType::Animation]),
        ...
        "SetAITargetGroup" => Signature::args(vec![EnumType::Footing, EnumType::Footing, EnumType::Boolean]),
        "SetAIGroupFooting" => Signature::args(vec![EnumType::Footing, EnumType::Footing]),
